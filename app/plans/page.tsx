...
const content = {
  ar: {
    ...
    mediaItems: [
      ...
      "استخدام شركاء إنتاج إعلامي مختارين عند الحاجة",
    ],
    plans: [
      {
        code: "A",
        ...
        route: [
          ...
          "اليوم 3: مواقع تراثية وثقافية مختارة، مع سوق الصفافير وجلسة توثيق إعلامي.",
          "اليوم 4-5: الكاظمية، جامع أم الطبول، أو فضاءات ثقافية وفنية حسب طبيعة الوفد.",
        ],
        highlights: [
          "وجهات تراثية وثقافية تقدم جلسات تعريفية بالتاريخ والعمارة والقطع المختارة.",
          "فضاءات ثقافية وفنية تعرّف الوفد بالمشهد الإبداعي العراقي.",
        ],
        digital:
          "يستخدم الوفد برنامجًا رقميًا مختصرًا قبل الوصول، مع خرائط يومية ورموز QR ونبذات افتراضية عن الوجهات المختارة.",
        services: [
      ...
      },
      {
        ...
        route: [
          "اليوم 1-2: بغداد الرسمية والثقافية، مع مواقع تراثية وفضاءات ثقافية وجولة افتراضية تمهيدية.",
        ...
        highlights: [
          "مواقع بغداد التراثية تقدم مدخلًا حيًا للعمارة والذاكرة الثقافية.",
          "يمكن إضافة شركاء وفضاءات إعلامية بحسب اهتمام الوفد.",
        ],
        digital:
      ...
      },
      {
        ...
        route: [
          ...
          "اليوم 9: الموصل والتراث الشمالي أو يوم إعلامي وثقافي مخصص حسب طبيعة الوفد.",
          "اليوم 10: مراجعة إعلامية، ملخص بصري للرحلة، لقاء ختامي، ومغادرة.",
        ],
        highlights: [
          "توظيف وجهات تراثية وجولات افتراضية كنقطة تعريف مبكرة بالتراث البغدادي.",
          "إدراج شركاء إنتاج ضمن محور الإعلام والثقافة عند الحاجة.",
        ],
        digital:
