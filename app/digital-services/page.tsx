...
const content = {
  ar: {
    ...
    modules: [
      ...
      ["الجولات الافتراضية", "عرض مواقع تراثية وثقافية مختارة قبل الزيارة، مع قابلية توسيع التجربة لمعالم أخرى."],
  ...
  en: {
    ...
    modules: [
      ...
      ["Virtual Tours", "Presenting selected cultural heritage sites before the visit, with expansion to further landmarks."],
