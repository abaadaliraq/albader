...
const copy = {
  ar: {
    ...
    subtitle: [
      ...
      "من بغداد الرسمية إلى الجنوب الحضاري وكردستان العراق.",
    ],
  ...
  en: {
    ...
    subtitle: [
      ...
      "From official Baghdad to the civilizational South and Iraqi Kurdistan.",
    ],
  ...
  zh: {
    ...
    title: "代表团接待方案",
    subtitle: [
      "根据访问时间、代表团级别与目标设计的三条灵活路线。",
      "从官方巴格达到文明南部与伊拉克库尔德斯坦。",
    ],
    button: "查看方案详情",
    plans: [
      {
